...
A full-stack Django web application for managing student records, adding marks, and viewing results with a beautiful, responsive UI. Built with MySQL backend, user authentication (login/register), and modern design using CSS3 and Unsplash backgrounds.
🚀 Features
...
└── resultapp/               # Core app
    ...
    │       └── images/
    │           ├── background.jpg  # Academic background
